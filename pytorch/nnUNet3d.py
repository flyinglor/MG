...
class DownTransition(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.current_depth == 2:  # Adjust this if you want the last block to not downsample
            return out_before_pool, out_before_pool
        else:
...
class nnUNet3D(nn.Module):
    ...
    def forward(self, x):
        ...
        self.out_up_128 = self.up_tr128(self.out256, self.skip_out128)
...
model = nnUNet3D(n_class=1, act='relu')
print(model)