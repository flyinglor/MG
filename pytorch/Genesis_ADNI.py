...
val_dir = "/dss/dsshome1/0C/ge79qex2/ModelsGenesis/generated_cubes/ADNI/valid_3_64x64x32.npy"
...
for epoch in range(intial_epoch,conf.nb_epoch):
	...
	if valid_loss < best_loss:
		...
		},os.path.join(conf.model_path, "Genesis_ADNI_3_2.pt"))
		print("Saving model ",os.path.join(conf.model_path,"Genesis_ADNI_3_2.pt"))
	else:
